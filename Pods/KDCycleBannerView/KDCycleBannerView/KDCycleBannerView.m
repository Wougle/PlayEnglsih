...
- (void)initializePageControl {
    ...
    _pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:((228.f) / 255.0) green:((75.f) / 255.0) blue:((59.f) / 255.0) alpha:((1.)/1.0)];
    _pageControl.pageIndicatorTintColor = [UIColor colorWithRed:((102.f) / 255.0) green:((102.f) / 255.0) blue:((102.f) / 255.0) alpha:((0.3)/1.0)];
