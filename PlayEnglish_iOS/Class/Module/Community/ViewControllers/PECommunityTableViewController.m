...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.personalHeadImgView.image = [UIImage imageNamed:tableMuArr[commCount - indexPath.row][@"headImage"]];
    cell.personalNameLabel.text = tableMuArr[commCount - indexPath.row][@"nickName"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [UserDefaultsUtils saveValue:tableMuArr[commCount - indexPath.row][@"headImage"] forKey:@"detailHeadImage"];
...
- (void)ReplayBtnCellDelegate:(NSIndexPath *)index{
    ...
    [UserDefaultsUtils saveValue:tableMuArr[commCount - index.row][@"headImage"] forKey:@"detailHeadImage"];
